...
GO
PRINT N'Creating [dbo].[FK_LAYOUT_VARIAVEIS_LAYOUT_VARIAVEIS]...';


GO
ALTER TABLE [dbo].[LAYOUT_VARIAVEIS] WITH NOCHECK
    ADD CONSTRAINT [FK_LAYOUT_VARIAVEIS_LAYOUT_VARIAVEIS] FOREIGN KEY ([LEIAUTEID]) REFERENCES [dbo].[LAYOUT] ([LEIAUTEID]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[LAYOUT_VARIAVEIS] WITH CHECK CHECK CONSTRAINT [FK_LAYOUT_VARIAVEIS_LAYOUT_VARIAVEIS];
