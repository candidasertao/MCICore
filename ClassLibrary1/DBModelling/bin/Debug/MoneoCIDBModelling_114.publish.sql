...
GO
PRINT N'Creating [dbo].[FK_USERS_RESETPASSWORD_CLIENTES]...';


GO
ALTER TABLE [dbo].[USERS_RESETPASSWORD] WITH NOCHECK
    ADD CONSTRAINT [FK_USERS_RESETPASSWORD_CLIENTES] FOREIGN KEY ([CLIENTEID]) REFERENCES [dbo].[CLIENTES] ([CLIENTEID]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_USERS_RESETPASSWORD_USERS]...';


GO
ALTER TABLE [dbo].[USERS_RESETPASSWORD] WITH NOCHECK
    ADD CONSTRAINT [FK_USERS_RESETPASSWORD_USERS] FOREIGN KEY ([USUARIOID]) REFERENCES [dbo].[USUARIOS] ([USUARIOID]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[USERS_RESETPASSWORD] WITH CHECK CHECK CONSTRAINT [FK_USERS_RESETPASSWORD_CLIENTES];

ALTER TABLE [dbo].[USERS_RESETPASSWORD] WITH CHECK CHECK CONSTRAINT [FK_USERS_RESETPASSWORD_USERS];
