...
GO
PRINT N'Dropping unnamed constraint on [dbo].[TIPOCAMPANHA]...';


GO
ALTER TABLE [dbo].[TIPOCAMPANHA] DROP CONSTRAINT [DF__TIPOCAMPA__ISEXC__1F63A897];
...
UPDATE [dbo].[TIPOCAMPANHA]
SET    [ISEXCLUDED] = 0
WHERE  [ISEXCLUDED] IS NULL;

ALTER TABLE [dbo].[TIPOCAMPANHA] ALTER COLUMN [ISEXCLUDED] BIT NOT NULL;
