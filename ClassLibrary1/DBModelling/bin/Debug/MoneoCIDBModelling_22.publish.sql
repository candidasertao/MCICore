...
GO
PRINT N'Dropping [dbo].[IDENTITYSERVER_CLIENTS_SCOPES].[IX_IDENTITYSERVER_CLIENTS_SCOPES_TOKEN]...';


GO
DROP INDEX [IX_IDENTITYSERVER_CLIENTS_SCOPES_TOKEN]
    ON [dbo].[IDENTITYSERVER_CLIENTS_SCOPES];
...
GO
ALTER TABLE [dbo].[IDENTITYSERVER_CLIENTS_SCOPES] ALTER COLUMN [TOKEN] VARCHAR (70) NULL;
