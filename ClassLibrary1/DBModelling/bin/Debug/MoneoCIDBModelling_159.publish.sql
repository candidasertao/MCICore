...
GO
PRINT N'Rename refactoring operation with key 94aeaf8d-a305-4238-a3ac-28925d3d6e92 is skipped, element [dbo].[RATINHOS_RECEBIMENTO].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';
...
GO
PRINT N'Creating [dbo].[RATINHOS_RECEBIMENTO]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '94aeaf8d-a305-4238-a3ac-28925d3d6e92')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('94aeaf8d-a305-4238-a3ac-28925d3d6e92')
