...
CREATE TABLE [dbo].[tmp_ms_xx_CAMPANHAS_CONSOLIDADO] (
    ...
    [ENVIADA]      AS            ENTREGUE + EXPIRADA + EXCLUIDA,
    [NAOENVIADA]   AS            ERRO + CANCELADA + SUSPENSA,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_CAMPANHAS_CONSOLIDADO] ([CODIGO], [CARTEIRAID], [ARQUIVOID], [DATAENVIAR], [USUARIOID], [CLIENTEID], [EXCLUIDA], [ERRO], [SUSPENSA], [ENTREGUE], [EXPIRADA], [DATADIA], [FORNECEDORID], [CANCELADA], [SPCAPITAL], [SPGRANDE], [DEMAISDDD])
        SELECT   [CODIGO],
                 [CARTEIRAID],
                 [ARQUIVOID],
                 [DATAENVIAR],
