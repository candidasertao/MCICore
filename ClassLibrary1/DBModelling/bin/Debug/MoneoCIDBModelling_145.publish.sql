...
GO
/*
The column STATUSOPERACIONAL on table [dbo].[FORNECEDOR_CLIENTE] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/

IF EXISTS (select top 1 1 from [dbo].[FORNECEDOR_CLIENTE])
...
GO
ALTER TABLE [dbo].[FORNECEDOR_CLIENTE] ALTER COLUMN [STATUSOPERACIONAL] TINYINT NOT NULL;
...
ALTER TABLE [dbo].[FORNECEDOR_CLIENTE]
    ADD DEFAULT 0 FOR [STATUSOPERACIONAL];
