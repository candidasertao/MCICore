...
GO
PRINT N'Dropping [dbo].[RATINHOS_RECEBIMENTO].[IX_RATINHOS_RECEDBIMENTO]...';


GO
DROP INDEX [IX_RATINHOS_RECEDBIMENTO]
    ON [dbo].[RATINHOS_RECEBIMENTO];


GO
PRINT N'Dropping [dbo].[RATINHOS_RECEBIMENTO].[IX_RATTINHOS_RECEBIMENTO_UNIQUE]...';


GO
DROP INDEX [IX_RATTINHOS_RECEBIMENTO_UNIQUE]
    ON [dbo].[RATINHOS_RECEBIMENTO];
