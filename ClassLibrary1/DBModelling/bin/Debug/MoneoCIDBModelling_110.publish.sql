...
GO
PRINT N'Creating [dbo].[CLIENTES_CONTATO].[IX_EMAIL_CLIENTES_EMAIL_UNIQUE]...';


GO
CREATE NONCLUSTERED INDEX [IX_EMAIL_CLIENTES_EMAIL_UNIQUE]
    ON [dbo].[CLIENTES_CONTATO]([EMAIL] ASC) WHERE EMAIL IS NOT NULL;
