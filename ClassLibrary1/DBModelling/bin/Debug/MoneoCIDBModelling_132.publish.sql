...
GO
/*
The column [dbo].[FORNECEDOR_CAMPANHAS].[STATUSENVIO] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[FORNECEDOR_CAMPANHAS])
...
GO
PRINT N'Altering [dbo].[FORNECEDOR_CAMPANHAS]...';
...
GO
ALTER TABLE [dbo].[FORNECEDOR_CAMPANHAS] DROP COLUMN [STATUSENVIO];
