...
GO
ALTER TABLE [dbo].[IDENTITYSERVER_CLIENTS_SCOPES] ALTER COLUMN [APISECRET] VARCHAR (50) NULL;


GO
ALTER TABLE [dbo].[IDENTITYSERVER_CLIENTS_SCOPES] ALTER COLUMN [APISECRET] ADD SPARSE;
