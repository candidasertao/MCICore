...
IF EXISTS (select top 1 1 from [dbo].[IDENTITYSERVER_CLIENTS_SCOPES])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping unnamed constraint on [dbo].[IDENTITYSERVER_CLIENTS_SCOPES]...';


GO
ALTER TABLE [dbo].[IDENTITYSERVER_CLIENTS_SCOPES] DROP CONSTRAINT [DF__IDENTITYSE__DATA__3EDC53F0];
...
GO
ALTER TABLE [dbo].[IDENTITYSERVER_CLIENTS_SCOPES] ALTER COLUMN [DATA] DATETIME NOT NULL;


GO
ALTER TABLE [dbo].[IDENTITYSERVER_CLIENTS_SCOPES]
    ADD [ISRESETED] BIT DEFAULT 0 NOT NULL;
