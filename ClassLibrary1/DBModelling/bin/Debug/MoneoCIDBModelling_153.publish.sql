...
GO
PRINT N'Dropping [dbo].[FK_CAMPANHAS_USUARIOS]...';


GO
ALTER TABLE [dbo].[CAMPANHAS] DROP CONSTRAINT [FK_CAMPANHAS_USUARIOS];
...
ALTER TABLE [dbo].[CAMPANHAS] WITH NOCHECK
    ADD CONSTRAINT [FK_CAMPANHAS_USUARIOS] FOREIGN KEY ([USUARIOID]) REFERENCES [dbo].[USUARIOS] ([USUARIOID]);
