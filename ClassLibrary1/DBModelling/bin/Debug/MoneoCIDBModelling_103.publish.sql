...
GO
PRINT N'Creating [dbo].[CK_USUARIOS_SALDO]...';


GO
ALTER TABLE [dbo].[USUARIOS] WITH NOCHECK
    ADD CONSTRAINT [CK_USUARIOS_SALDO] CHECK (SALDO>=0);
...
GO
ALTER TABLE [dbo].[USUARIOS] WITH CHECK CHECK CONSTRAINT [CK_USUARIOS_SALDO];
