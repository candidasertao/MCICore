...
GO
PRINT N'The following operation was generated from a refactoring log file ac56450f-b7b4-4990-959f-a8327de202d0';

PRINT N'Rename [dbo].[IDENTITYSERVER_CLIENTS_SCOPES].[CODIGO] to ID';


GO
EXECUTE sp_rename @objname = N'[dbo].[IDENTITYSERVER_CLIENTS_SCOPES].[CODIGO]', @newname = N'ID', @objtype = N'COLUMN';
