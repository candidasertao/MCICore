...
GO
PRINT N'Dropping [dbo].[USUARIOS].[IX_USUARIOS_EMAIL]...';


GO
DROP INDEX [IX_USUARIOS_EMAIL]
    ON [dbo].[USUARIOS];


GO
PRINT N'Dropping [dbo].[USUARIOS].[IX_USUARIOS_LOGINUSER]...';


GO
DROP INDEX [IX_USUARIOS_LOGINUSER]
    ON [dbo].[USUARIOS];
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_USUARIOS_EMAIL]
    ON [dbo].[USUARIOS]([EMAIL] ASC, [ISEXCLUDED] ASC);
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_USUARIOS_LOGINUSER]
    ON [dbo].[USUARIOS]([LOGINUSER] ASC, [ISEXCLUDED] ASC);
