...
GO
PRINT N'Dropping [dbo].[LAYOUT_VARIAVEIS].[IX_VARIAVEL_LAYOUT]...';


GO
DROP INDEX [IX_VARIAVEL_LAYOUT]
    ON [dbo].[LAYOUT_VARIAVEIS];
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_VARIAVEL_LAYOUT]
    ON [dbo].[LAYOUT_VARIAVEIS]([LEIAUTEID] ASC, [VARIAVEL] ASC);


GO
PRINT N'Creating [dbo].[LAYOUT_VARIAVEIS].[IX_IDCOLUNA_LAYOUT]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_IDCOLUNA_LAYOUT]
    ON [dbo].[LAYOUT_VARIAVEIS]([LEIAUTEID] ASC, [IDCOLUNA] ASC);


GO
PRINT N'Creating [dbo].[LEIAUTE_TRIGGER]...';
