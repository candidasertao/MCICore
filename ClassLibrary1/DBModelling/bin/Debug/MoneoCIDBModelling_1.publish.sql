...
GO
PRINT N'Dropping unnamed constraint on [dbo].[CARTEIRAS]...';


GO
ALTER TABLE [dbo].[CARTEIRAS] DROP CONSTRAINT [DF__CARTEIRAS__ISEXC__1E6F845E];
...
GO
PRINT N'Altering [dbo].[CARTEIRAS]...';
...
UPDATE [dbo].[CARTEIRAS]
SET    [ISEXCLUDED] = 0
WHERE  [ISEXCLUDED] IS NULL;

ALTER TABLE [dbo].[CARTEIRAS] ALTER COLUMN [ISEXCLUDED] BIT NOT NULL;
...
GO
PRINT N'Altering [dbo].[TIPOCAMPANHA]...';
...
GO
PRINT N'Refreshing [dbo].[GESTORESSMS]...';
...
GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GESTORESSMS]';
