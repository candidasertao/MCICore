...
GO
PRINT N'The following operation was generated from a refactoring log file b14e6201-9be5-476a-872a-a3a7ba79298e';

PRINT N'Rename [dbo].[LAYOUT_VARIAVEIS].[LAYOUTID] to LEIAUTEID';


GO
EXECUTE sp_rename @objname = N'[dbo].[LAYOUT_VARIAVEIS].[LAYOUTID]', @newname = N'LEIAUTEID', @objtype = N'COLUMN';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b14e6201-9be5-476a-872a-a3a7ba79298e')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b14e6201-9be5-476a-872a-a3a7ba79298e')
