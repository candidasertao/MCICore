...
GO
PRINT N'Altering [dbo].[GRUPOUSUARIOS]...';
...
UPDATE [dbo].[GRUPOUSUARIOS]
SET    [ISEXCLUDED] = 0
WHERE  [ISEXCLUDED] IS NULL;

ALTER TABLE [dbo].[GRUPOUSUARIOS] ALTER COLUMN [ISEXCLUDED] BIT NOT NULL;
...
GO
PRINT N'Creating unnamed constraint on [dbo].[GRUPOUSUARIOS]...';
