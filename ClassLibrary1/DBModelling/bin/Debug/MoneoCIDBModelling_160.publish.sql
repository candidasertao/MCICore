...
GO
/*
The column CELULAR on table [dbo].[RATINHOS] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.

The column DATA on table [dbo].[RATINHOS] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
ALTER TABLE [dbo].[RATINHOS] ALTER COLUMN [CELULAR] NUMERIC (12) NOT NULL;

ALTER TABLE [dbo].[RATINHOS] ALTER COLUMN [DATA] DATETIME NOT NULL;
