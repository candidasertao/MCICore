...
GO
PRINT N'Rename refactoring operation with key 03dbbf7a-d37a-40a9-9920-87d910bbc978, f761f5a8-f093-45c9-913e-5ec4b3018c19 is skipped, element [dbo].[GRUPOUSUARIOS].[Id] (SqlSimpleColumn) will not be renamed to GRUPOUSUARIOID';


GO
PRINT N'Rename refactoring operation with key b77925ed-d5cc-47a8-9eeb-5068579bed62 is skipped, element [dbo].[GRUPOUSUARIOS_ACESSOS].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 330d2e06-bb61-4aa5-82e8-aa553960e5b8 is skipped, element [dbo].[GRUPOUSUARIOS_ACESSOS].[PAGINA] (SqlSimpleColumn) will not be renamed to PAGINAID';


GO
PRINT N'Rename refactoring operation with key 202feca3-d0ff-4985-9d10-53f860aea015, ef8c6949-b61f-41e0-b505-1b1bdeed9d1e is skipped, element [dbo].[PAGINAS].[Id] (SqlSimpleColumn) will not be renamed to PAGINAID';


GO
PRINT N'Rename refactoring operation with key f455c56e-0b64-4dea-a8f8-384fc694eec8 is skipped, element [dbo].[GRUPOPAGINAS].[Id] (SqlSimpleColumn) will not be renamed to GRUPOID';


GO
PRINT N'Rename refactoring operation with key c3a73694-3a2c-4f2d-b365-0bd71ef8a992, 1ff6824e-a2c5-43b8-988c-f5e418989159, a0762d13-5c34-4752-9e3c-b072dec5211a, 61eb7677-30ee-444e-aed3-a2ac21f0d0d6 is skipped, element [dbo].[CLIENTES_PAGINAS].[Id] (SqlSimpleColumn) will not be renamed to CLIENTEPAGINAID';


GO
PRINT N'Rename refactoring operation with key da68ac9d-0db0-420b-b770-02253210591d is skipped, element [dbo].[CLIENTES_PAGINAS_GRUPOUSUARIO].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 0151b716-201d-451a-b104-61ac1ecac791 is skipped, element [dbo].[CLIENTES_PAGINAS].[PERMISSAO''] (SqlSimpleColumn) will not be renamed to PERMISSAO';


GO
PRINT N'Rename refactoring operation with key 144a6bf2-cc7c-4314-8d74-4f81f6175fe6 is skipped, element [dbo].[CELULAR_BLACKLIST].[CODIGO] (SqlSimpleColumn) will not be renamed to BLACKLISTID';


GO
PRINT N'Rename refactoring operation with key 62cc0f2b-9cdc-47d9-9f08-3271cee2e1c5 is skipped, element [dbo].[CELULAR_BLACKLIST].[DATAGRAVACAO] (SqlSimpleColumn) will not be renamed to DATA';


GO
PRINT N'Rename refactoring operation with key b1808ac1-ad01-451a-956c-bac655c7aae3 is skipped, element [dbo].[CELULARES_INVALIDOS].[TEXTO] (SqlSimpleColumn) will not be renamed to MENSAGEM';


GO
PRINT N'Rename refactoring operation with key 15623f02-3870-4786-b9f4-7685456b783f is skipped, element [dbo].[FORNECEDOR_CLIENTE].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 6cb94a2c-bc0c-40f1-8f84-4d3b6c7a5a0a is skipped, element [dbo].[CARTEIRA_TELEFONES].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 1d718a52-5d35-43e8-b51f-610305a7a952 is skipped, element [dbo].[USUARIOS].[COTAU] (SqlSimpleColumn) will not be renamed to COTA';


GO
PRINT N'Rename refactoring operation with key 23d072c5-90e4-436f-aae8-856c0bbf4ce4 is skipped, element [dbo].[CLIENTES_CONTATO].[TIPOCONTATO] (SqlSimpleColumn) will not be renamed to DESCRICAO';


GO
PRINT N'Rename refactoring operation with key a87d23a6-fe44-4722-a5c0-ae8401ba1560 is skipped, element [dbo].[CLIENTES_CONFIGURACAO].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 085ed727-4e98-4712-94a5-267f87000a2c is skipped, element [dbo].[CLIENTES_CONFIGURACAO].[CLIENTEid] (SqlSimpleColumn) will not be renamed to CLIENTEID';


GO
PRINT N'Rename refactoring operation with key 4e6e3942-21c9-4605-ad39-c8b7702ae770 is skipped, element [dbo].[CAMPANHA_RETORNO].[DATAGRAVACAO] (SqlSimpleColumn) will not be renamed to DATA';


GO
PRINT N'Rename refactoring operation with key 164eb5af-20bb-4214-8331-149d9d754e0f is skipped, element [dbo].[LOG_ATIVIDADE].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 2a4e5900-0ae3-46e1-945d-9bc2832c61cf is skipped, element [dbo].[LOG_ATIVIDADE].[CLIENTEIDID] (SqlSimpleColumn) will not be renamed to CLIENTEID';


GO
PRINT N'Rename refactoring operation with key 4e1f8538-4233-4d7a-8ea5-198681f5e68a is skipped, element [dbo].[ATIVIDADES].[Id] (SqlSimpleColumn) will not be renamed to ATIVIDADEID';


GO
PRINT N'Rename refactoring operation with key 9fee87c1-48b5-4984-8735-bd29327e6807 is skipped, element [dbo].[LOG_ATIVIDADE].[ATIVIDADE] (SqlSimpleColumn) will not be renamed to ATIVIDADEID';


GO
PRINT N'Rename refactoring operation with key f82165c7-dcd9-477d-8543-a90018f3d412 is skipped, element [dbo].[CAMPANHA_RETORNO].[CLENTEID]]] (SqlSimpleColumn) will not be renamed to CLENTEID';


GO
PRINT N'Rename refactoring operation with key a5a326a0-d4b2-4ec5-a251-34f28efd00f2 is skipped, element [dbo].[RETORNO_INTERJEICAO].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 8a46db95-5188-4c1e-bd9d-bc97e15ea2e2 is skipped, element [dbo].[RATINHOS].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 3a6f0dca-0347-4edd-b30e-5585114fa727 is skipped, element [dbo].[CONSOLIDADO_RETORNOS].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 0edc63a9-e0e8-408f-8184-e720375de75a is skipped, element [dbo].[CONSOLIDADO_RETORNOS].[CLASSIFICACAO] (SqlSimpleColumn) will not be renamed to POSITIVO';


GO
PRINT N'Rename refactoring operation with key b064eecf-839d-4dbb-ac88-02636213b209 is skipped, element [dbo].[CELULARES_INVALIDOS_CONSOLIDADO].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 5fb88459-05fb-48bb-aa6a-f3f5da346508 is skipped, element [dbo].[CAMPANHAS_CONSOLIDADO].[SP] (SqlSimpleColumn) will not be renamed to SPCAPITAL';


GO
PRINT N'Rename refactoring operation with key dc7eb513-1871-4515-b243-ba9625a52614, c8a20adb-0928-48f9-ba1c-2a305e8d8e89 is skipped, element [dbo].[REQUISICAO_RELATORIO].[Id] (SqlSimpleColumn) will not be renamed to REQUISICAOID';


GO
PRINT N'Rename refactoring operation with key 0431bf6c-c4b7-40ad-8c5b-6f64f0fe0e53, 13384730-2d74-4aaf-9052-9c28d9ce346a is skipped, element [dbo].[REQUISICAO_RELATORIO_CARTEIRAS].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 100f9d7e-03dd-4554-89b5-c5476b11ea99 is skipped, element [dbo].[REQUISICAO_RELATORIO_EMAILS].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key bcef732b-c227-4097-b30a-d935560b1e31 is skipped, element [dbo].[UFDDD].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 51aa4387-f99d-4691-b040-dea3995fae5b is skipped, element [dbo].[REQUISICAO_RELATORIO].[UPLOADED] (SqlSimpleColumn) will not be renamed to GERADO';


GO
PRINT N'Rename refactoring operation with key c65fa66d-0444-46d2-9035-a7b73aa073e0 is skipped, element [dbo].[REQUISICAO_RELATORIO].[STATUSARQUIVO] (SqlSimpleColumn) will not be renamed to STATUSRELATORIO';


GO
PRINT N'Rename refactoring operation with key dc40a696-5c52-455c-8af8-56eba8d7d9d5 is skipped, element [dbo].[BOLETOLANDING].[CONTAID] (SqlSimpleColumn) will not be renamed to CARTEIRAID';
...
GO
PRINT N'Rename refactoring operation with key 99237be5-4ae4-426b-ad9b-dd6921883acc is skipped, element [dbo].[CELULARES_INVALIDOS_CONSOLIDADO].[ARQUIVOID] (SqlSimpleColumn) will not be renamed to ARQUIVO';


GO
PRINT N'Rename refactoring operation with key e1d11e3d-b66e-47a2-b0ac-704fdd1f5764 is skipped, element [dbo].[CAMPANHAS_ARQUIVOS_FILESZIP].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 3d83f2d5-5856-47e5-a853-7043a25bc82c is skipped, element [dbo].[SESSION].[Id] (SqlSimpleColumn) will not be renamed to CODIGO';


GO
PRINT N'Rename refactoring operation with key 792cc854-5f36-426a-80c1-7ccba6006e34 is skipped, element [dbo].[SESSION].[HASHCODE] (SqlSimpleColumn) will not be renamed to ARQUIVO';


GO
PRINT N'Rename refactoring operation with key cca2ebca-5778-4555-affc-7758cd6e1ca3 is skipped, element [dbo].[SESSION_ITENS].[ID] (SqlSimpleColumn) will not be renamed to GUID';


GO
PRINT N'Rename refactoring operation with key 7988352c-cba7-45c9-b059-200235bab30c is skipped, element [dbo].[SESSION].[SESSIONID] (SqlSimpleColumn) will not be renamed to GUID';


GO
PRINT N'Rename refactoring operation with key 71fe831d-7be1-4ccb-82d4-53fd712786ae is skipped, element [dbo].[SESSION] (SqlTable) will not be renamed to [FILECARDS]';
