...
GO
PRINT N'The following operation was generated from a refactoring log file 99237be5-4ae4-426b-ad9b-dd6921883acc';

PRINT N'Rename [dbo].[CELULARES_INVALIDOS_CONSOLIDADO].[ARQUIVOID] to ARQUIVO';


GO
EXECUTE sp_rename @objname = N'[dbo].[CELULARES_INVALIDOS_CONSOLIDADO].[ARQUIVOID]', @newname = N'ARQUIVO', @objtype = N'COLUMN';
...
GO
PRINT N'Altering [dbo].[CELULARES_INVALIDOS_CONSOLIDADO]...';
...
GO
ALTER TABLE [dbo].[CELULARES_INVALIDOS_CONSOLIDADO] ALTER COLUMN [ARQUIVO] VARCHAR (255) NULL;
