...
GO
/*
The column ATIVOLOGIN on table [dbo].[FORNECEDOR] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Dropping unnamed constraint on [dbo].[FORNECEDOR]...';


GO
ALTER TABLE [dbo].[FORNECEDOR] DROP CONSTRAINT [DF__FORNECEDO__ATIVO__2C88998B];
...
GO
ALTER TABLE [dbo].[FORNECEDOR] ALTER COLUMN [ATIVOLOGIN] BIT NOT NULL;
