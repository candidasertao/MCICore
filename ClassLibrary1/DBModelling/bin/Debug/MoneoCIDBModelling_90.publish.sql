...
GO
/*
The column [dbo].[PADRAO_POSTAGENS].[TIPOCAMPANHAID] on table [dbo].[PADRAO_POSTAGENS] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
ALTER TABLE [dbo].[PADRAO_POSTAGENS]
    ADD [TIPOCAMPANHAID] INT NOT NULL,
        [USUARIOID]      INT NULL;
...
GO
PRINT N'Creating [dbo].[FK_PADRAO_POSTAGENS_TIPOCAMPANHA]...';


GO
ALTER TABLE [dbo].[PADRAO_POSTAGENS] WITH NOCHECK
    ADD CONSTRAINT [FK_PADRAO_POSTAGENS_TIPOCAMPANHA] FOREIGN KEY ([TIPOCAMPANHAID]) REFERENCES [dbo].[TIPOCAMPANHA] ([CODIGO]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[PADRAO_POSTAGENS] WITH CHECK CHECK CONSTRAINT [FK_PADRAO_POSTAGENS_TIPOCAMPANHA];
