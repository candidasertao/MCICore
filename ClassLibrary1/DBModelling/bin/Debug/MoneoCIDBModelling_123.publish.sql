...
GO
PRINT N'Rename refactoring operation with key 6e2a0110-726c-45ed-b1e4-64a97580a3c0 is skipped, element [dbo].[FORNECEDOR].[ATIVO] (SqlSimpleColumn) will not be renamed to ATIVOLOGIN';
...
ALTER TABLE [dbo].[FORNECEDOR]
    ADD [ATIVOLOGIN] BIT DEFAULT 0 NULL;
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6e2a0110-726c-45ed-b1e4-64a97580a3c0')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6e2a0110-726c-45ed-b1e4-64a97580a3c0')
