...
GO
PRINT N'The following operation was generated from a refactoring log file 792cc854-5f36-426a-80c1-7ccba6006e34';

PRINT N'Rename [dbo].[SESSION].[HASHCODE] to ARQUIVO';


GO
EXECUTE sp_rename @objname = N'[dbo].[SESSION].[HASHCODE]', @newname = N'ARQUIVO', @objtype = N'COLUMN';


GO
PRINT N'Dropping [dbo].[SESSION].[IX_SESSION_UNIQUE_SESSION_HASHCODE]...';


GO
DROP INDEX [IX_SESSION_UNIQUE_SESSION_HASHCODE]
    ON [dbo].[SESSION];
...
GO
ALTER TABLE [dbo].[SESSION] ALTER COLUMN [ARQUIVO] VARCHAR (255) NOT NULL;
...
GO
PRINT N'Creating [dbo].[SESSION].[IX_SESSION_UNIQUE_SESSION_HASHCODE]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_SESSION_UNIQUE_SESSION_HASHCODE]
    ON [dbo].[SESSION]([SESSIONID] ASC, [ARQUIVO] ASC);
