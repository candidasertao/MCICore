...
GO
PRINT N'Creating [dbo].[CK_GRUPOUSUARIOS_COTA_SALDO]...';


GO
ALTER TABLE [dbo].[GRUPOUSUARIOS] WITH NOCHECK
    ADD CONSTRAINT [CK_GRUPOUSUARIOS_COTA_SALDO] CHECK (COTA>=SALDO);
...
GO
ALTER TABLE [dbo].[GRUPOUSUARIOS] WITH CHECK CHECK CONSTRAINT [CK_GRUPOUSUARIOS_COTA_SALDO];
