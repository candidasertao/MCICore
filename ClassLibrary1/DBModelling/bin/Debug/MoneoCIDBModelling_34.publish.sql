...
IF EXISTS (select top 1 1 from [dbo].[REJEITADAS_ANTERIORES])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [dbo].[REJEITADAS_ANTERIORES].[IX_REJEITADAS_ANTERIORES_CELULAR_Includes]...';


GO
DROP INDEX [IX_REJEITADAS_ANTERIORES_CELULAR_Includes]
    ON [dbo].[REJEITADAS_ANTERIORES];
...
GO
PRINT N'Altering [dbo].[REJEITADAS_ANTERIORES]...';
...
GO
ALTER TABLE [dbo].[REJEITADAS_ANTERIORES] DROP COLUMN [STATUSREPORT];


GO
ALTER TABLE [dbo].[REJEITADAS_ANTERIORES]
