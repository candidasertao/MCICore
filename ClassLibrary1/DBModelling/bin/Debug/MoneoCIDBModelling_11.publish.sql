...
GO
ALTER TABLE [dbo].[CAMPANHAS_CONSOLIDADO] DROP COLUMN [NAOENVIADA], COLUMN [ENVIADA];


GO
ALTER TABLE [dbo].[CAMPANHAS_CONSOLIDADO] ALTER COLUMN [EXCLUIDA] INT NOT NULL;


GO
ALTER TABLE [dbo].[CAMPANHAS_CONSOLIDADO]
    ADD [ENVIADA]    AS ENTREGUE + EXPIRADA + EXCLUIDA,
