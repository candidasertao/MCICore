...
GO
PRINT N'Creating [dbo].[FORNECEDOR_CONTATO].[IX_FORNECEDOR_CONTATO_EMAIL_UNIQUE]...';


GO
CREATE NONCLUSTERED INDEX [IX_FORNECEDOR_CONTATO_EMAIL_UNIQUE]
    ON [dbo].[FORNECEDOR_CONTATO]([EMAIL] ASC) WHERE EMAIL IS NOT NULL;
